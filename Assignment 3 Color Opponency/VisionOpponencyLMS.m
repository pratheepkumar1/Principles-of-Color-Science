...
change_in_wavelength = mean(diff(light_sources_dataset{:,1}))
...
LMS_incandescent_stimuli = transpose(lms_matrix * s_incandescent_matrix * r_matrix);
LMS_daylight_stimuli = transpose(lms_matrix * s_daylight_matrix * r_matrix);
